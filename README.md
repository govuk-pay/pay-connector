...
[View the API specification for connector in Swagger Editor](https://editor.swagger.io/?url=https://raw.githubusercontent.com/govuk-pay/pay-connector/master/openapi/connector_spec.yaml).
...
| `SECURE_WORLDPAY_NOTIFICATION_DOMAIN`                           | `.worldpay.com`                            | incoming requests will have a reverse DNS lookup done on their domain. They must resolve to a domain with this suffix (see `IpDomainMatcher.ipMatchesDomain()`)                                                                                                                                                                      |
...
## Adyen direct integration variables

All Adyen configuration uses the `GDS_CONNECTOR_ADYEN_` prefix and supports separate `test` and `live` values.
Test config files include declarations for test URLs for balancePlatform, legalEntityManagement and management. These
are required and overridden in integration tests only, and do not require values to be set.

| Variable                                                              | Default                               | Purpose                                                                                                                                                                                   |
|-----------------------------------------------------------------------|---------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `GDS_CONNECTOR_ADYEN_BASE_URL_CHECKOUT_TEST`                          | `https://checkout-test.adyen.com/v71` | Checkout API base URL for test accounts                                                                                                                                                   |
| `GDS_CONNECTOR_ADYEN_BASE_URL_CHECKOUT_LIVE`                          | -                                     | Checkout API base URL for live accounts                                                                                                                                                   |                                                                                                                                                                                            |
| `GDS_CONNECTOR_ADYEN_BASE_URL_BALANCE_PLATFORM_TEST`                  | -                                     |                                                                                                                                                                                           |
| `GDS_CONNECTOR_ADYEN_BASE_URL_LEGAL_ENTITY_MANAGEMENT_TEST`           | -                                     |                                                                                                                                                                                           |
| `GDS_CONNECTOR_ADYEN_BASE_URL_MANAGEMENT_TEST`                        | -                                     |                                                                                                                                                                                           |
| `GDS_CONNECTOR_ADYEN_MERCHANT_ACCOUNT_ID_TEST`                        | -                                     | Adyen merchant account ID for test payments                                                                                                                                               |
| `GDS_CONNECTOR_ADYEN_MERCHANT_ACCOUNT_ID_LIVE`                        | -                                     | Adyen merchant account ID for live payments                                                                                                                                               |
| `GDS_CONNECTOR_ADYEN_BALANCE_PLATFORM_ID_TEST`                        | -                                     | Balance platform ID used with test merchant account                                                                                                                                       |
| `GDS_CONNECTOR_ADYEN_BALANCE_PLATFORM_ID_LIVE`                        | -                                     | Balance platform ID used with live merchant account                                                                                                                                       |
| `GDS_CONNECTOR_ADYEN_COMPANY_ACCOUNT_API_KEY_TEST`                    | -                                     | Company account API key (used for Adyen's Checkout API to process payments and Management API to process manage stores, payment methods and other config) for test                        |
| `GDS_CONNECTOR_ADYEN_COMPANY_ACCOUNT_API_KEY_LIVE`                    | -                                     | Company account API key for live                                                                                                                                                          |
| `GDS_CONNECTOR_ADYEN_BALANCE_PLATFORM_API_KEY_TEST`                   | -                                     | Balance Platform API key (used for Adyen's APIs to create account holders and balance accounts, schedule payouts, transfer funds, and make one-off payouts) for test                      |
| `GDS_CONNECTOR_ADYEN_BALANCE_PLATFORM_API_KEY_LIVE`                   | -                                     | Balance Platform API key                                                                                                                                                                  |
| `GDS_CONNECTOR_ADYEN_LEGAL_ENTITY_MANAGEMENT_API_KEY_TEST`            | -                                     | Legal Entity Management API key for test                                                                                                                                                  |
| `GDS_CONNECTOR_ADYEN_LEGAL_ENTITY_MANAGEMENT_API_KEY_LIVE`            | -                                     | Legal Entity Management API key (used for Adyen's Legal Entity Management API to create and manage legal entities that contain the information required for verification checks) for live |
| `GDS_CONNECTOR_ADYEN_NOTIFICATION_DOMAIN`                             | `.adyen.com`                          | Allowed notification domain suffix for Adyen webhooks                                                                                                                                     |
| `GDS_CONNECTOR_ADYEN_HMAC_KEY_PAYMENTS_TEST_PRIMARY`                  | -                                     | Primary HMAC key to validate HMAC signature for test payment webhooks                                                                                                                     |
| `GDS_CONNECTOR_ADYEN_HMAC_KEY_PAYMENTS_TEST_SECONDARY`                | -                                     | Secondary HMAC key to validate HMAC signature for test payment webhooks (set when rotating HMAC key)                                                                                      |
| `GDS_CONNECTOR_ADYEN_HMAC_KEY_PAYMENTS_LIVE_PRIMARY`                  | -                                     | Primary HMAC key to validate HMAC signature for live payment webhooks                                                                                                                     |
| `GDS_CONNECTOR_ADYEN_HMAC_KEY_PAYMENTS_LIVE_SECONDARY`                | -                                     | Secondary HMAC key to validate HMAC signature for live payment webhooks (set when rotating HMAC key)                                                                                      |
| `GDS_CONNECTOR_ADYEN_HMAC_KEY_TOKENS_TEST_PRIMARY`                    | -                                     | Primary HMAC key to validate HMAC signature for test token webhooks                                                                                                                       |
| `GDS_CONNECTOR_ADYEN_HMAC_KEY_TOKENS_TEST_SECONDARY`                  | -                                     | Secondary HMAC key to validate HMAC signature for test token webhooks (set when rotating HMAC key)                                                                                        |
| `GDS_CONNECTOR_ADYEN_HMAC_KEY_TOKENS_LIVE_PRIMARY`                    | -                                     | Primary HMAC key to validate HMAC signature for live token webhooks                                                                                                                       |
| `GDS_CONNECTOR_ADYEN_HMAC_KEY_TOKENS_LIVE_SECONDARY`                  | -                                     | Secondary HMAC key to validate HMAC signature for live token webhooks (set when rotating HMAC key)                                                                                        |
| `GDS_CONNECTOR_ADYEN_HMAC_KEY_TRANSFER_TEST_PRIMARY`                  | -                                     | Primary HMAC key to validate HMAC signature for test transfer webhooks                                                                                                                    |
...
| `GDS_CONNECTOR_ADYEN_HMAC_KEY_BALANCE_PLATFORM_REPORT_TEST_PRIMARY`   | -                                     | Primary HMAC key to validate HMAC signature for Adyen's test balance platform report webhooks                                                                                             |
| `GDS_CONNECTOR_ADYEN_HMAC_KEY_BALANCE_PLATFORM_REPORT_TEST_SECONDARY` | -                                     | Secondary HMAC key to validate HMAC signature for Adyen's test balance platform report webhooks (set when rotating HMAC key)                                                              |
| `GDS_CONNECTOR_ADYEN_HMAC_KEY_BALANCE_PLATFORM_REPORT_LIVE_PRIMARY`   | -                                     | Primary HMAC key to validate HMAC signature for Adyen's live balance platform report webhooks                                                                                             |
| `GDS_CONNECTOR_ADYEN_HMAC_KEY_BALANCE_PLATFORM_REPORT_LIVE_SECONDARY` | -                                     | Secondary HMAC key to validate HMAC signature for Adyen's live balance platform report webhooks (set when rotating HMAC key)                                                              |
...
| `AWS_SQS_PAYMENT_EVENT_QUEUE_URL`              | -       | SQS event queue URL                                                                                     |
...
| `EXPUNGE_CHARGES_OLDER_THAN_DAYS`                               | 2       | Expunge charges (in terminal state) older than 2 days (or as configured) based on created date                                               | 
...
| `EXPUNGE_REFUNDS_OLDER_THAN_DAYS`                               | 2       | Expunge refunds older than 2 days (or as configured) based on created date                                                                   |
...
Task Queue is used for processing different tasks (Recurring payments authorisation, Retrying failed payment or refund
emails
